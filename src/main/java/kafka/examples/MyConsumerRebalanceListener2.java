...
public class MyConsumerRebalanceListener2 implements org.apache.kafka.clients.consumer.ConsumerRebalanceListener {

    private final String logTag = "MyConsumerRebalanceListener2";

    //private OffsetManager offsetManager = new OffsetManager("storage2");
    private Consumer<String, String> consumer;

    public MyConsumerRebalanceListener2(Consumer consumer) {
