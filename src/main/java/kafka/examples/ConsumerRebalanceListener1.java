...
public class ConsumerRebalanceListener1 extends Thread
{
    private final KafkaConsumer<Integer, String> consumer;
    private final String topic;
    private final DateFormat df;
    private final String logTag = "ConsumerRebalanceListener1";

    public ConsumerRebalanceListener1(Properties props)
    {
        consumer = new KafkaConsumer<>(props);
        this.topic = props.getProperty("topic");
        this.df = new SimpleDateFormat("HH:mm:ss");

        consumer.subscribe(Collections.singletonList(this.topic), new MyConsumerRebalanceListener1(consumer));
