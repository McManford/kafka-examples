...
public class ConsumerProducerDemo2
{
    public static void main(String[] args)
    {
        ...
        Consumer1 consumer1Thread = new Consumer1(kprops.TOPIC);
        consumer1Thread.start();

        Consumer2 consumer2Thread = new Consumer2(kprops.TOPIC);
        consumer2Thread.start();

        Consumer3 consumer3Thread = new Consumer3(kprops.TOPIC);
